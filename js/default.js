...
$(document).on('pagebeforeshow', '#groepen', function() {
    ...
    $(document).on("pagebeforeshow", "#create-account-1", function() {
    ...
    $(document).on( "pagebeforeshow", "#poolPage", function( e ) {
    	urlObject = purl();
 ...
 $(document).on( "pagebeforeshow", "#create-soccerpool-1", function( e ) {
 ...
 $(document).on( "pagebeforeshow", "#manual-login", function( e ) {
 ...
 $(document).on( "pagebeforeshow", "#prediction_step_new", function( e ) {
